...
class CartPage(BasePage):
    ...
    _checkout_button = (By.CSS_SELECTOR, "a[class='checkout-button button alt wc-forward']")
...
class CartItem(BaseRegion):
    _name = (By.CSS_SELECTOR, "td[data-title='Produkt']")
    _item_unit_price = (By.CSS_SELECTOR, "td[data-title='Cena']")
    _quantity = (By.CSS_SELECTOR, "td[class*='product-quantity'] input")
    ...
    @property
    def quantity(self):
        quantity = self.find_element(*self._quantity)
        return quantity.get_attribute("value")

    @property
    def item_total_price(self):
        total_price = self.find_element(*self._item_total_price).text
