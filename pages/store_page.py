...
class StorePage(BasePage):
    ...
    def add_item_to_cart(self, item_name):
        ...
        self.wait.until(lambda page: menu.amount != "0,00", "Amount is equal to 0,00 after adding an item to cart!")


class Item(BaseRegion):
    _name = (By.CSS_SELECTOR, "h2[class*='woocommerce-loop-product']")
    _add_to_cart_button = (By.CSS_SELECTOR, "a[class*='button product_type_simple add_to_cart']")
